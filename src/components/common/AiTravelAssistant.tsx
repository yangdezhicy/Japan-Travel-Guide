...
const WELCOME: ChatMessage = {
  id: 'welcome',
  role: 'assistant',
  text: '你好，我是日本旅游 AI 小助手 👋 现已接入大模型，并结合站内真实景点、美食、购物与价格数据回答，会记住你的城市 / 预算 / 同行人，尽量给出具体、可执行的建议。',
  bullets: ['试试：带爸妈去京都大阪玩 5 天怎么排？', '试试：3 万日元预算在东京买什么划算？', '也可以直接说城市名切换话题'],
  chips: ['第一次去东京怎么安排？', '带爸妈去关西玩什么？', '樱花季几月去？'],
}
