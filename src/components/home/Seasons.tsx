      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="max-w-3xl mb-14 reveal show">
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="eyebrow">最佳季节</span>
          </div>
          ...
          {seasonCards.map((card, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-white grid place-items-center mb-6 border hairline">
                <span className={`text-2xl leading-none ${card.iconClass}`}>{card.icon}</span>
              </div>
              <p className="text-[11px] tracking-[.18em] text-muted mb-2">{card.label}</p>
